    ...
    return (
        ...
        <footer className="bg-[#071952] text-[#ebf4f6] py-4">
            <div className="container mx-auto text-center flex flex-col items-center lg:flex-row lg:justify-between lg:items-center gap-2">
                <p className="text-xl">Cohort 54 group 2.</p>
                <p className='text-xl'>&copy; All rights reserved.</p>
                <div className='flex gap-5 lg:gap-10 pt-2'>
                    <a href='https://github.com/JoaquinNeulist/BattleShipGameProyectBack.git' target='blank'>
                    ...
                    <a href='https://github.com/russokun/BattleShipGameProyectFront.git' target='blank'>
