...
const ShipContainer = ({ show }) => {
    ...
    return (
        <div className="flex relative flex-wrap md:flex-row flex-col items-start p-4 rounded-md backdrop-blur border-[0.1px] border-white md:h-[450px] md:w-[210px] h-[160px] w-[90vw] md:mt-[70px]">
